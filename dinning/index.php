    ...
    <div class="container">
        ...
        <div class="wlv-top-nav-inner">
            ...
            <ul class="wlv-top-nav">
                        ...
                        <li class="menu-item ss" runat="server" id="liMenu">
                            <a id="top_0_header_1_RptNavigation_LnkItem_3" class="menu-item" href="index.php">DINING</a>
                        </li>
                        <li class="menu-item ss" runat="server" id="liMenu">
...
<script type="text/javascript">
    ...
    $('#wlv-room-reservation-form').hide();
    $('#wlv-dining-reservation-form').show();
...
<!-- Carousel ================================================== -->
<div id="body_0_maincolumninternal_0_internal1content_0_CarouselWrapper" class="carousel-wrapper">
    ...
    <div class="carousel-inner" role="listenbox">
      <div class="item active">
        <img src="images/pic1.jpg" class="d-block img-fluid" title="TEXT ABOUT IMAGE">
        <div class="carousel-caption">
          <h2>TEXT ABOUT IMAGE</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/pic2.jpg" class="d-block img-fluid" title="TEXT ABOUT IMAGE">
        <div class="carousel-caption">
          <h2>TEXT ABOUT IMAGE</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/pic3.jpg" class="d-block img-fluid" title="TEXT ABOUT IMAGE">
        <div class="carousel-caption">
          <h2>TEXT ABOUT IMAGE</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/pic4.jpg" class="d-block img-fluid" title="TEXT ABOUT IMAGE">
        <div class="carousel-caption">
          <h2>TEXT ABOUT IMAGE</h2>
        </div>
      </div>
    ...
    <a href="#carousel-1" class="left carousel-control" role="button" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left" aria-hidde="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a href="#carousel-1" class="right carousel-control" role="button" data-slide="next">
      <span class="glyphicon glyphicon-chevron-right" aria-hidde="true"></span>
...
<div>
    ...
    <div class="row nomargin">
        <div class="text-center col-md-12 visible-md-block visible-lg-block scroll-down-wrap">
            <a href="#main-content" class="scroll-indicator dark one-page-arrow d-table m-auto" style="opacity: 1;"><span class="glyphicon glyphicon-chevron-down"></span><span class="scroll-text">SCROLL DOWN</span><span class="glyphicon glyphicon-chevron-down"></span></a>
        </div>
    </div>


    <div class="row wlv-footer-wrapper nomargin" id="main-content">
        <div class="col-sm-7 col-md-5 col-md-offset-2">


<div class="row section-image-vert">
    <div class="image-vert">
        <div class="carousel slide" id="carousel-2" data-ride="carousel">
    <div class="carousel-inner" role="listenbox">
      <div class="item active">
        <img src="images/bg1.jpg" class="d-block img-fluid" title="RESTAURANT TYPE 1">
        <div class="carousel-caption">
          <h2>RESTAURANT TYPE 1</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/bg2.jpg" class="d-block img-fluid" title="RESTAURANT TYPE 2">
        <div class="carousel-caption">
          <h2>RESTAURANT TYPE 2</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/bg3.jpg" class="d-block img-fluid" title="RESTAURANT TYPE 3">
        <div class="carousel-caption">
          <h2>RESTAURANT TYPE 3</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/bg4.jpg" class="d-block img-fluid" title="RESTAURANT TYPE 4">
        <div class="carousel-caption">
          <h2>RESTAURANT TYPE 4</h2>
        </div>
      </div>
    ...
    <div class="section-caption-vert">
        <h3>
            
        </h3>
        <strong style="font-family: AvenirLTStd85Heavy;"></strong>Talk about the different restaurant categories
        <div class="section-right-cta">
            <a href="restauranttypes.php" id="RedirectAnchor" target="_self">
...
<div class="row section-image-vert">
    <div class="image-vert">
        <img src="images/bg1.jpg" width="1920" height="1080">
    </div>
    <div class="section-caption-vert">
        <h3>
            
        </h3>
        <strong style="font-family: AvenirLTStd85Heavy;">RESTAURANT TYPE 1 </strong>description here
        <div class="section-right-cta">
            <a href="restauranttype1.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT RESTAURANT TYPE 1
            </a>
...
<div class="row section-image-vert">
    <div class="image-vert">
        <img src="images/bg2.jpg" width="1920" height="1080">
    </div>
    <div class="section-caption-vert">
        <h3>
            
        </h3>
        <strong style="font-family: AvenirLTStd85Heavy;">RESTAURANT TYPE 2 </strong>description here
        <div class="section-right-cta">
            <a href="restauranttype2.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT RESTAURANT TYPE 2
            </a>
...
<div class="row section-image-vert">
    <div class="image-vert">
        <img src="images/bg3.jpg" width="1920" height="1080">
    </div>
    <div class="section-caption-vert">
        <h3>
            
        </h3>
        <strong style="font-family: AvenirLTStd85Heavy;">RESTAURANT TYPE 3 </strong>description here
        <div class="section-right-cta">
            <a href="restauranttype3.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT RESTAURANT TYPE 3
            </a>
...
<div class="row section-image-vert">
    <div class="image-vert">
        <img src="images/bg4.jpg" width="1920" height="1080">
    </div>
    <div class="section-caption-vert">
        <h3>
            
        </h3>
        <strong style="font-family: AvenirLTStd85Heavy;">RESTAURANT TYPE 4 </strong>description here
        <div class="section-right-cta">
            <a href="restauranttype4.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT RESTAURANT TYPE 4
            </a>
        ...
        <div class="col-sm-5 col-md-3 right-column-content">
            
    <div class="">
					<h3 class="section-header-right">ABOUT HOTEL NAME RESTAURANTS</h3>
					<div class="section-text-right"> 
                        <h2 class="section-header"></h2>
								
								<div class="section-text"> 
                                    <p style="border: none;">Brief desciption of the restaurants in the hotel and other facilities present in the rooms</p>
                                </div>
                            </div>
					</div>
    </div>
...
<footer class="row wlv-home-footer nomargin">
    <div class="container-fluid">
