    ...
    <div class="container">
        ...
        <div class="wlv-top-nav-inner">
            ...
            <ul class="wlv-top-nav">
                        ...
                        <li class="menu-item ss" runat="server" id="liMenu">
                            <a id="top_0_header_1_RptNavigation_LnkItem_2" class="menu-item" href="index.php">ROOMS & SUITES</a>
                        </li>
...
<div class="row section-image-vert">
    ...
    <div class="carousel-inner" role="listenbox">
      <div class="item active">
        <img src="images/bg1.jpg" class="d-block img-fluid" title="ROOM TYPE 1">
        <div class="carousel-caption">
          <h2>ROOM TYPE 1</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/bg2.jpg" class="d-block img-fluid" title="ROOM TYPE 2">
        <div class="carousel-caption">
          <h2>ROOM TYPE 2</h2>
        </div>
      </div>
      <div class="item">
        <img src="images/bg3.jpg" class="d-block img-fluid" title="ROOM TYPE 3">
        <div class="carousel-caption">
          <h2>ROOM TYPE 3</h2>
        </div>
      </div>
    ...
    <div class="section-caption-vert">
        ...
        <strong style="font-family: AvenirLTStd85Heavy;"></strong>Talk about the different room categories
        <div class="section-right-cta">
            <a href="roomtypes.php" id="RedirectAnchor" target="_self">
                VIEW ALL ROOM TYPES
            </a>
...
<div class="row section-image-vert">
    ...
    <div class="section-caption-vert">
        ...
        <strong style="font-family: AvenirLTStd85Heavy;">ROOM TYPE 1 </strong>description here
        <div class="section-right-cta">
            <a href="roomtype1.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT ROOM TYPE 1
            </a>
...
<div class="row section-image-vert">
    ...
    <div class="section-caption-vert">
        ...
        <strong style="font-family: AvenirLTStd85Heavy;">ROOM TYPE 2 </strong>description here
        <div class="section-right-cta">
            <a href="roomtype2.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT ROOM TYPE 2
            </a>
...
<div class="row section-image-vert">
    ...
    <div class="section-caption-vert">
        ...
        <strong style="font-family: AvenirLTStd85Heavy;">ROOM TYPE 3 </strong>description here
        <div class="section-right-cta">
            <a href="roomtype3.php" id="RedirectAnchor" target="_self">
                VIEW MORE DETAILS ABOUT ROOM TYPE 3
            </a>
    ...
    <div class="">
					<h3 class="section-header-right">ABOUT HOTEL NAME ROOMS</h3>
					<div class="section-text-right"> 
                        <h2 class="section-header"></h2>
								
								<div class="section-text"> 
                                    <p style="border: none;">Brief desciption of the rooms in the hotel and other facilities present in the rooms</p>
                                </div>
                            </div>
					</div>
    </div>
